...
<%@ page import="com.yuanlrc.entity.*" %>
<% String path = request.getContextPath(); %>
<%@page import="com.yuanlrc.util.MTimeUtil"%>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
						...
						<form method="post" class="form-horizontal" action="">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
						   		...
						   		<div class="col-md-4">
							        ...
							        <p class="form-control-static"><%=history.getHome() %></p>
							    </div>
							</div>
							<div class="form-group">
						    	<div class="col-md-1"></div>
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-8">
									...
									<a href="<%=path %>/history/list.do?pageNo=1" class="btn btn-info">返&nbsp;&nbsp;回</a>
								</div>
							</div>
						</form>
					</div>
